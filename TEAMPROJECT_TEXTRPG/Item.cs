namespace TEAMPROJECT_TEXTRPG
{
    ...
    internal class Items()
    {
        internal List<Item> items = new List<Item>()
        {
            ...
            new Item(3, "회복 포션", 2, 0, 3, 30, "", false),
            new Item(4, "전리품 A", 0, 0, 0, 0, "", false), // 미니언이 드랍할 전리품
            new Item(5, "전리품 B", 0, 0, 0, 0, "", false), // 공허충이 드랍할 전리품
            new Item(6, "전리품 C", 0, 0, 0, 0, "", false), // 대포 미니언이 드랍할 전리품
        };
    }
}
